...
<div align="center">
  ...
  <b>🗂️ 词组</b> · <sub>以「组」为单位组织背单词——把共享同一 <b>词缀 / 词根 / 形近</b> 的词圈成一个命名的组，以组记忆；<b>一个词可同时属于多个组</b>（词↔组多对多），成员词显示「也在这些组」。组按类型分色（词缀蓝 / 词根绿 / 形近橙）+ 建组 / 类型筛选 / 搜索；组内单词可 <b>↑↓ 手动调序</b>（触屏也能用）。<b>加词一个入口</b>：库里有就搜出来点选加入，<b>库里没有直接新建并自动查词</b>（音标 / 释义 / 例句自动补全）；成员词可 <b>✎ 编辑</b>，标注<b>前缀 / 词根 / 后缀</b>（建议来自「词根词缀」三库，如 reduce→re-+duc，chip 蓝 / 绿 / 紫分色）。与「背单词」<b>共享同一份词库</b>，编辑同步、词不重录。</sub>
</div>
