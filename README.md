...
<td width="50%" valign="top">
  ...
  <b>✅ 待办看板</b><br>
  <sub>当前聚焦 + 今日待办（列表 / 四象限两视图，可设截止时间按紧迫度自动排序）。完成的事项收进 <b>✅ 今日已完成</b> + 跨日沉入 <b>🏆 成就记录</b> 按日期回看（成就墙）+ 🔥 连续打卡，攒成就感不再手删。另含长期任务（起止 + 倒计时）+ 周·月计划（目标 + 复盘 + 自动归档）+ 项目追踪三层，项目可「派单」到今日待办双向同步。</sub>
</td>
<td width="50%" valign="top">
