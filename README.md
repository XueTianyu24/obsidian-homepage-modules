...
<div align="center">
  ...
  <b>⏱️ 专注规划</b> · <sub>手动记每天的专注 / 学习时长，一屏看清「今天 / 本周 / 本月 / 本年」+ 三种日均。<b>月历热力</b>：格子按当天时长四档加深（有记录 / ≥3h / ≥6h / ≥9h）、<b>格内直接显示小时数</b>、今天蓝描边，点格子弹窗填「小时 + 分钟」补记 / 修改 / 清除，任意切月（跨年也行）。统计口径讲究：<b>活跃日均只按有记录的天数真算</b>（没有明细显示「需逐日明细」，不编数字）；只知道历史月份总数？<b>手填月总兜底</b>，之后补明细自动以明细为准。下方按所选月份<b>实际周数</b>生成「✨ 周计划」卡片，点卡片写这一周的安排（支持 Markdown 加粗 / 高亮 / 列表），当前周高亮。还支持粘贴旧版 Habit Planner Sync 插件 data.json 一键迁移。</sub>
</div>
