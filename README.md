...
<div align="center">
  ...
  <b>🔐 账号密码</b> · <sub>把账号密码从散乱笔记里收进来，<b>能存能搜能一键复制</b>。<b>🔑 KEY 密码本</b>是核心：把反复复用的常用密码建成 KEY，账号密码可<b>「引用 KEY」</b>——改一处、所有账号同步生效，还自动反查「哪些账号在用它」。三视图：<b>账号</b>（分类彩色标签 + 筛选）/ <b>KEY 密码本</b> / <b>归属</b>（按注册邮箱·手机号分组），顶部全局模糊搜。密码默认<b>打码</b>，👁 点开看 / 📋 一键复制。安全上走<b>「明文存储 + 访问口令轻门禁」</b>（防随手翻页 / 肩窥，口令可随时改）；支持 JSON 批量导入迁移旧记录。</sub>
</div>
