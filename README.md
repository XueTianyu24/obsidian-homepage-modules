...
<div align="center">
  ...
  <b>🧠 思维导图</b> · <sub>在笔记里画 XMind 式<b>可编辑思维导图</b>——以中心主题往外发散、<b>双侧自动布局</b>，不用手动摆位置。桌面上：<b>单击选中、双击 / F2 改字、Tab 加子节点、Enter 加同级、Del 删</b>（含子树），有子节点的节点外侧 –/＋ 一点<b>折叠</b>整棵子树；拖空白<b>平移</b>、滚轮<b>缩放</b>、右下角 ＋/－/⤢ 按钮、双击空白复位到中心。每个顶层分支一种 Nord 色、子孙继承，连线随分支色。顶部可建<b>多张导图</b>切换（＋新建 / ⚙管理）。<b>手机端只读</b>：查看 / 平移 / 缩放 / 折叠，编辑在电脑上做。</sub>
</div>
