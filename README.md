...
番茄、自律、健身、精听听写、词根词缀、词组、账号密码、专注规划、出门清单、求职进度、思维导图、画布、天气、会议 DDL、每日安排、日历、统计、倒计时等 **31 个交互模块**；再用「主页」把它们拼成一张
...
<td width="50%" valign="top">
  ...
  <b>✅ 待办看板</b><br>
  <sub>当前聚焦 + 今日待办（列表 / 四象限两视图，<b>切到哪个下次默认哪个</b>，可设截止时间按紧迫度自动排序，可标 <b>▶ 进行中</b> 让正在做的浮到最上）。完成的事项收进 <b>✅ 今日已完成</b> + 跨日沉入 <b>🏆 成就记录</b> 按日期回看（成就墙）+ 🔥 连续打卡，攒成就感不再手删。<b>🔁 周期任务</b>（每天 / 每周几 / 每月几号 / 每 N 天重复，到期自动进今日待办、打勾次日重现）。另含长期任务（起止 + 倒计时）+ 周·月计划（目标 + 复盘 + 自动归档）+ 项目追踪三层，项目可「派单」到今日待办双向同步。</sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <b>📈 项目日志</b><br>
  <sub>项目→主题→每日条目三级管理 + 项目须知(Markdown) + <b>每项目独立「📄 开发流程」长文档</b>（独立 .md 记 SOP / 踩坑，真编辑器编辑 + 折叠预览）+ 待办（<b>可归属主题</b>，项目级总览 + 主题卡内汇总）；四视图（折叠日志 / 按天 / 热力图 / 甘特泳道），主题区间自动推导，重叠即并行。<b>条目正文支持 Markdown</b>（加粗 / 列表 / 勾选框 / 代码 / wikilink，多行编辑 Ctrl+Enter 提交）。主题多时顶部有<b>🗂 主题目录</b>点击跳转 + 全部展开 / 折叠成大纲。</sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <b>📔 日记记录</b><br>
  <sub><b>⭐ 每日打分（0–10）+ 月度热力日历</b>：点日期格子打分、按月切换、三档配色（🟥差 🟨中 🟩好）、右栏当月日均 + 分布。<b>📝 周总结 / 月总结</b>：周 / 月视图顶部就近写回顾，「📚 总结」tab 集中翻看，正文用 <b>Obsidian 原生编辑器（Live Preview 所见即所得）</b>。另有每日体重 / 睡眠 / 工作 / 健身 4 个数字 + 💧 喝水打卡（早中晚各 2 杯）+ 时间段日志 + 周 / 月视图与汇总。</sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <b>📆 每日安排</b><br>
  <sub>一天的固定作息骨架：时间段排成时间轴（<b>高度随事项内容撑开</b>），当前块高亮 + 按进度填充；「现在」卡大字提醒该做什么 / 还剩多久 / 下一项预告；时段开始弹提醒。<b>可建多套作息方案（学校 / 假期一键切换）</b>，适用日再分工作日 / 周末；每个时段内可像日记那样「＋ 加一项」逐行加具体事、原地编辑 / ↑↓ 调序。</sub>
</td>
<td width="50%" valign="top">
...
<div align="center">
  ...
  <b>🗂️ 词组</b> · <sub>以「组」为单位组织背单词——把共享同一 <b>词缀 / 词根 / 形近</b> 的词圈成一个命名的组，以组记忆；<b>一个词可同时属于多个组</b>（词↔组多对多），成员词显示「也在这些组」。组按类型分色（词缀蓝 / 词根绿 / 形近橙）+ 建组 / 类型筛选 / 搜索；组内单词可 <b>↑↓ 手动调序</b>（触屏也能用）；成员词写的<b>巧记备注</b>会在单词下方整行显示，记的助记看得到。<b>加词一个入口</b>：库里有就搜出来点选加入，<b>库里没有直接新建并自动查词</b>（音标 / 释义 / 例句自动补全）；成员词可 <b>✎ 编辑</b>，标注<b>前缀 / 词根 / 后缀</b>（建议来自「词根词缀」三库，如 reduce→re-+duc，chip 蓝 / 绿 / 紫分色）。与「背单词」<b>共享同一份词库</b>，编辑同步、词不重录。</sub>
</div>
...
<div align="center">
  ...
  <b>💼 求职进度</b> · <sub>秋招 / 春招投很多家公司时，一目了然看——<b>投了哪些公司、什么岗位、什么时候投的、进度到哪一步</b>。以「一家投递 = 一张卡」为单位。<b>两种视图</b>：<b>列表</b>（一家一张大卡，信息全，点阶段徽标弹菜单快速改阶段）/ <b>看板</b>（按 投递·筛选 / 笔试 / 面试中 / Offer / 已挂拒 <b>5 列分布</b>，卡片压缩、一屏看清进度分布），右上一键切换、记住选择。顶部<b>漏斗概览</b>：投递总数 + 面试中 / Offer / 进行中 / 已挂拒 + 分段漏斗条。阶段流水线 <b>已投递 → 简历筛选 → 笔试 → 一 / 二 / 三面·HR 面 → 🎉Offer</b> + 终态「已挂 / 被拒」「我已回绝」，Offer 卡淡绿高亮、终态卡置灰划线，每张卡带 5 段迷你进度条；每次改阶段自动记<b>时间线</b>。</sub>
</div>
...
- **🔄 在线更新（脱离 BRAT）** —— 插件内直接检查 / 一键更新，不用再装 BRAT。有新版时**主页 + 工作台顶部弹醒目横幅**，设置「检查更新」和命令面板也能随时主动查；点「立即更新」自动下载 + 重载生效（桌面 + 移动端通用）。**提示式、点确认才装**，不会偷偷自动换版本；作者可用 GitHub pre-release 灰度、坏版本不会推给你。
...
装好后，命令面板（Ctrl / Cmd + P）搜「**创建效率工具页面**」，或在 **设置 → Homepage Modules → 快速开始** 点「创建页面」：插件会在你 vault 的「效率工具」目录下，为日记 / 番茄 / 待办 / 背单词 / 词组 / 自律 / 精神内核 / 天气 / 健身 / 健身日记 / 精听听写 / 词根词缀 / 项目日志 / 提示词库 / 个人信条 / 学术 DDL / 每日安排 / 日历 / 账号密码 / 专注规划各建一个**开箱即用**的页面 + 一张总览导航页。
