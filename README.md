...
<div align="center">
  ...
  <b>⏱️ 专注规划</b> · <sub>手动记每天的专注 / 学习时长，一屏看清「今天 / 本周 / 本月 / 本年」+ 三种日均。<b>月历热力</b>：格子按当天时长四档加深（有记录 / ≥3h / ≥6h / ≥9h）、<b>格内直接显示小时数</b>、今天蓝描边，点格子弹窗填「小时 + 分钟」补记 / 修改 / 清除，任意切月（跨年也行）。统计口径讲究：<b>活跃日均只按有记录的天数真算</b>（没有明细显示「需逐日明细」，不编数字）；只知道历史月份总数？<b>手填月总兜底</b>，之后补明细自动以明细为准。下方按所选月份<b>实际周数</b>生成「✨ 周计划」卡片：点卡片写这一周的安排，编辑工具条<b>选中文字点 B / 五色淡高光圆点</b>即打标记（同色再点取消、换色直接点，不用手打语法）——高光渲染成<b>圆角小色块标签</b>、<b>加粗显示淡粉红</b>；大项下行首空格缩进小计划、显示原样保留；当前周高亮。还支持粘贴旧版 Habit Planner Sync 插件 data.json 一键迁移（五色高光颜色保留）。</sub>
</div>
