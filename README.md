...
<div align="center">
  ...
  <b>🗂️ 词组</b> · <sub>以「组」为单位组织背单词——把共享同一 <b>词缀 / 词根 / 形近</b> 的词圈成一个命名的组，以组记忆；<b>一个词可同时属于多个组</b>（词↔组多对多），成员词显示「也在这些组」。组按类型分色（词缀蓝 / 词根绿 / 形近橙）+ 建组 / 加词（从词库全库模糊搜索，或新建词直接建库并加入）/ 类型筛选 / 搜索。与「背单词」<b>共享同一份词库</b>——组只存词的引用，释义 / 音标 / 复习进度全共享，词不重录。</sub>
</div>
