...
<td width="50%" valign="top">
  ...
  <b>✅ 待办看板</b><br>
  <sub><b>🗓️ 今日规划</b>：每天上班先手写「今天要做什么」的一张白纸（只手动写、不从汇总搬；勾完划线留原位，头部显示日期 + 进度 + 🔥 连续），<b>跨日自动开新的一天</b>、往日留库当历史；上次没做完的顶部一行 <b>↪ 顺延到今天</b>（复制一份，历史那天仍记着当天没做完）。<b>📅 每日记录</b>：全年热力图（色深＝当天完成件数），<b>点某天看那天的完整清单</b>——规划了啥、哪些没做完、从汇总完成了啥、打了哪些周期卡。<b>📥 待办汇总</b>：长期堆着的所有事，列表 / 四象限两视图（<b>切到哪个下次默认哪个</b>）+ 截止时间自动排序 + <b>▶ 进行中</b>，完成的收进 <b>✅ 今日已完成</b>。<b>🔁 周期任务</b>（每天 / 每周几 / 每月几号 / 每 N 天重复，到期自动出现、打勾次日重现）。另含长期任务（起止 + 倒计时）+ 周·月计划（目标 + 复盘 + 自动归档）+ 项目追踪三层，项目可「派单」到汇总双向同步。</sub>
</td>
<td width="50%" valign="top">
