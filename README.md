...
<td width="50%" valign="top">
  ...
  <b>✅ 待办看板</b><br>
  <sub>当前聚焦 + 今日待办（列表 / 四象限两视图，可设截止时间按紧迫度自动排序）+ 长期任务（起止 + 倒计时）+ 周·月计划（目标 + 复盘 + 自动归档）+ 项目追踪三层，项目可「派单」到今日待办双向同步。</sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <b>📈 项目日志</b><br>
  <sub>项目→主题→每日条目三级管理 + 项目须知(Markdown) + 待办（<b>可归属主题</b>，项目级总览 + 主题卡内汇总）；四视图（折叠日志 / 按天 / 热力图 / 甘特泳道），主题区间自动推导，重叠即并行。主题多时顶部有<b>🗂 主题目录</b>点击跳转 + 全部展开 / 折叠成大纲。</sub>
</td>
<td width="50%" valign="top">
...
<td width="50%" valign="top">
  ...
  <b>🧮 待办 · 四象限</b><br>
  <sub>「今日待办」可切到艾森豪威尔四象限视图：按重要 / 紧急把待办分到 2×2 四格，未分类的待在「收集箱」；点色点或拖进格子即归类，格内按截止时间排，帮你决定先做什么。</sub>
</td>
</tr>
</table>
